...
from pic4rl_testing.tasks.Vineyards.pic4rl_environment_camera_depth import Pic4rlEnvironmentCamera
...
class Pic4rlTesting_Vineyard(Pic4rlEnvironmentCamera):
    def __init__(self):
        super().__init__()
        self.log_check()
