...
class Pic4rlEnvironmentCamera(Node):
    ...
    def _step(self, twist=Twist(), reset_step = False):
        ...
        self.spin_sensors_callbacks()
        lidar_measurements, depth_image, goal_info, robot_pose, collision, _ = self.get_sensor_data()
    ...
    def get_sensor_data(self):
        ...
        return lidar_measurements, depth_image, goal_info, robot_pose, collision, velocities
    ...
    def reset(self, n_episode, tot_steps, evaluate=False):
        ...
        logging.info(f"Total_episodes: {n_episode}{' evaluation episode' if self.evaluate else ''}, Total_steps: {tot_steps}, episode_steps: {self.episode_step+1}\n")
        print()
