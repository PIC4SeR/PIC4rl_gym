...
class Pic4rlEnv_Camera(py_environment.PyEnvironment, Node):
    """
    """
    def __init__(self, env_name="Generic_Pic4rlEnv_Camera"):
        """
        """
    ...
    def _step(self, action=np.array([]), reset_step=False):
        ...
        self.state = self.get_observation(depth_image, goal_info)
    ...
    def get_observation(self, depth_image, goal_info):
        """
        """
        goal_info   = np.array(goal_info)
